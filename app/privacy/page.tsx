...
export const metadata = {
    title: 'Privacy Policy | Pipey Pro',
        ...
        <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
            ...
            <main className="pt-32 pb-24 px-6">
                <div className="max-w-3xl mx-auto prose prose-slate">
                    ...
                    <p>At Pipey Pro, we recognize that privacy is significant. This Privacy Policy applies to the collection, use, and disclosure of personal information by Pipey Pro and its affiliates.</p>
                    ...
                    <p>We may share your information with our network of trusted third-party service providers (licensed plumbers and installers) solely for the purpose of fulfilling your service requests.</p>

                    <h2>4. Data Security</h2>
                    <p>We take reasonable measures to help protect information about you from loss, theft, misuse and unauthorized access.</p>

                    <h2>5. Contact Us</h2>
                    <p>If you have any questions about this Privacy Policy, please contact us at support@pipeypro.com.</p>
                </div>
            </main>
